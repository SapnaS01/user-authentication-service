...
public class JwtService {
    ...
    /**
     * Generate access token (no extra claims for now)
     */
    ...
    /**
     * Generate refresh token (no extra claims for now)
     */
    public String generateRefreshToken(User user) {
    	System.out.println("Generating refresh token for user: " + jwtProperties.getAccessExpiration());
        return buildToken(Map.of(), user.getId(), jwtProperties.getRefreshExpiration());
    }

    /**
     * Build a signed JWT with required claims.
     */
